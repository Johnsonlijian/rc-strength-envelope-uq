...
d=pd.read_csv(PROC/"column_with_mech.csv")
...
ax.axhline(0.9,ls="--",c="k",lw=0.8); ax.text(1.5,0.915,"0.90",fontsize=6.5,ha="right")
ax.set_xticks(x); ax.set_xticklabels(lab); ax.set_ylim(0,1.08); ax.set_ylabel("90% interval coverage")
...
for xi,ci_v,ce_v in zip(x,ci,ce):
    ax.text(xi-0.19,ci_v+0.012,f"{ci_v:.2f}",ha="center",va="bottom",fontsize=6.5,color="#555")
